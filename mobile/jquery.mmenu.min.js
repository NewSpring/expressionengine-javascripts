...
(function($) {
    ...
    $[_PLUGIN_].prototype['_addon_' + _ADDON_] = function() {
        ...
        //	Add the HTML
        if (opts.add) {
            var content = opts.content ? opts.content : '<a class="' + _c.prev + '" href="#">Back</a><span class="' + _c.title + '"></span><a class="' + _c.next + '" href="#"></a>';
                            ...
                            $t.off(_e.updateheader)
                                .on(_e.updateheader,
                                    function(e) {
                                        ...
                                        if (titl.indexOf(opts.title) === 0) $titl[titl ? 'show' : 'hide']().text(titl);
                                        else $titl[titl ? 'hide' : 'hide']().text(titl);
...
(function($) {
    ...
    $[_PLUGIN_].prototype['_addon_' + _ADDON_] = function() {
        ...
        function getPanelsOffset() {
            ...
            return hassearch ? hasheader ? 100 : 50 : hasheader ? 60 : 0;
        }
    };
...
(function($) {
    ...
    $[_PLUGIN_].prototype['_addon_' + _ADDON_] = function() {
        ...
        if (opts.add) {
            $('<div class="' + _c.search + '" />')
                .prependTo(this.$menu)
                .append('<a href="home" class="home ns-icon-home"></a>')
                .append('<div class="search-wrapper"><input placeholder="' + opts.placeholder + '" type="text" autocomplete="off" /><i class="fa fa-search"></i></div>');
            ...
            if ($input.length) {
                ...
                $input
                    ...
                    .keyup(function(e) {
                        ...
                        if ($input.val().length != 0) $icon.removeClass('fa-search').addClass('fa-times');
                        else $icon.removeClass('fa-times').addClass('fa-search');
                    })
                    .on(_e.keyup,
                        function(e) {
